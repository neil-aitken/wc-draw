...
def analyze_uefa_pot2_pot3():
    ...
    uefa_pot2 = [team for team, info in teams.items() 
                 if info['confederation'] == 'UEFA' and info['pot'] == 2]
    uefa_pot3 = [team for team, info in teams.items() 
                 if info['confederation'] == 'UEFA' and info['pot'] == 3]

...
def test_seed_1769482225_group_j_has_two_pot4_teams():
    ...
    draw_pot(pots[4], groups, rng=rng, allow_early=True, config=config)
    draw_pot(pots[2], groups, rng=rng, allow_early=True, config=config)
    draw_pot(pots[3], groups, rng=rng, allow_early=True, config=config)
